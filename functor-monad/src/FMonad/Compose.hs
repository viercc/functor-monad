...
deriving via
  ((g :.: f) a)
  instance
    (Eq1 f, Eq1 g, Eq a) => Eq (ComposePre f g a)

deriving via
  ((g :.: f) a)
  instance
    (Ord1 f, Ord1 g, Ord a) => Ord (ComposePre f g a)

deriving via
  (g :.: f)
  instance
    (Eq1 f, Eq1 g) => Eq1 (ComposePre f g)

deriving via
  (g :.: f)
  instance
    (Ord1 f, Ord1 g) => Ord1 (ComposePre f g)

deriving via
  (g :.: f)
  instance
    (Applicative f, Applicative g) => Applicative (ComposePre f g)

deriving via
  (g :.: f)
  instance
    (Applicative f, Alternative g) => Alternative (ComposePre f g)
...
deriving stock instance
  (Traversable f, Traversable g, Traversable h) => Traversable (ComposeBoth f g h)

deriving via
  ((f :.: h :.: g) a)
  instance
    (Eq1 f, Eq1 g, Eq1 h, Eq a) => Eq (ComposeBoth f g h a)

deriving via
  ((f :.: h :.: g) a)
  instance
    (Ord1 f, Ord1 g, Ord1 h, Ord a) => Ord (ComposeBoth f g h a)

deriving via
  (f :.: h :.: g)
  instance
    (Applicative f, Applicative g, Applicative h) => Applicative (ComposeBoth f g h)

deriving via
  (f :.: h :.: g)
  instance
    (Alternative f, Applicative g, Applicative h) => Alternative (ComposeBoth f g h)
